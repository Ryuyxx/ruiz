...
export default function Profile() {
    return (
        <Layout title="Profile">
            <div
                className="bg-white text-center shadow-xl p-8 w-72 rounded-2xl dark:bg-gray-800 h-96 hover:shadow-2xl duration-500">
                <div className="mt-4">
                ...
                <div className="mt-4">
                    <p className="font-bold my-1 mt-6 text-gray-600">Hoi Ching Chan</p>
                    <p className="text-xs mb-4 text-gray-600 ">Designer Model</p>
                    <p className="font-bold">Location</p>
                    <p className="text-xs mb-4 text-gray-600">Tokyo, Japan</p>
                    <p className="font-bold">E-mail</p>
                    <p className="text-xs mb-4 text-gray-600">ruizu@gmail.com</p>
                ...
                <div className="mt-8 flex justify-around">
                    ...
                    <div>
                        ...
                        >
                            <svg
                                className="w-6 h-6 fill-current text-black-500 inset-0 transform  hover:scale-75 transition duration-300 opacity-30 cursor-not-allowed"
                                fill="currentColor" viewBox="0 0 20 20">
                                <path
                    ...
                    <div>
                        ...
                        >
                            <svg
                                className="w-6 h-6 fill-current text-black-100 inset-0 transform  hover:scale-75 transition duration-300"
